...
export const StyledAnimation = styled.div`
  ...
  .toggle--daynight .toggle--btn:after {
    ...
    box-shadow: ${({ theme }) => theme.grays.white} 0 0,
      ...
      ${({ theme }) => theme.grays.white} 7px -7px 0 1px, #d3d3d3 0 0 0 4px,
      #d3d3d3 6px 0 0 4px, #d3d3d3 11px 0 0 4px, #d3d3d3 16px 0 0 4px,
      #d3d3d3 21px -1px 0 5px, #d3d3d3 16px -7px 0 1px, #d3d3d3 7px -7px 0 5px;
